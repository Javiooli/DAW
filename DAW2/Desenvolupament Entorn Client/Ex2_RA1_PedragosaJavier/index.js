...
const path = require('path');  //Importació de la llibreria Path per poder trobar la ruta de l'arxiu HTML
...
la sol·licitud (req) i la resposta (res). En aquest cas, enviem una resposta l'arxiu index.html.
Serveix per mostrar la nostra pàgina web en la pàgina d'inici del servidor.*/ 

// Definim la ruta de l'arxiu HTML
app.get('/', (req, res) => {
    // Enviem l'arxiu HMTL com a resposta
