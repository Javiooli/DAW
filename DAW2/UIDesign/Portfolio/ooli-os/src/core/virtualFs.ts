        ...
        visitor: {
          ...
          children: {
            ...
            'quick-info.md': {
              type: 'file',
              content: [
                'Javier Pedragosa, 23 years old.\n',
                '- Based in Esparreguera, Barcelona 🇪🇸.\n',
                "- CFGS Desenvolupament d'Aplicacions Web (Web app dev.) in INS Daniel Blanxart, Olesa de Montserrat.\n",
                '- Junior Developer in Volkswagen Group Services (CICD & Automations), since June 2025.\n',
                '- Fluent in `Python`, `Javascript`, `Typescript`, `Java`, `PHP`, `Spanish`, `Catalan` and `English`. Beginner in `C++`, `German` and `Japanese`.\n',
                '',
                '## Commands to try',
                '- `help`',
                '- `sysinfo`',
                ...
                '- `notepad ideas`',
                '',
                '- In order to open .txt or .md files, use `./filename`.',
