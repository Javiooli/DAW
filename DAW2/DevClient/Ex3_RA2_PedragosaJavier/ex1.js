/*
    Exercicis Inventari
    Exerici 1 - Inventari bàsic amb arrays
    Javier Pedragosa, DAW2
    Desenv. Entorn Client

    Enunciat:
    Crea un programa en JavaScript que gestioni un inventari de productes mitjançant un array
    d'objectes.

    Requisits:
    L'array ha de contenir almenys 5 productes inicials.
    No es pot comprar més quantitat que l'estoc disponible.
    L'estoc ha de disminuir i els venuts augmentar.
*/
...
function test(_args) {
    ...
    if (!error) {
        inventari.comprar(productNames[0], inventari.cercarProducte(productNames[0]).stock + 1);
    }
}
